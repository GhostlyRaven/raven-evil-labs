...
3. В процессе подбора конфигурации должна быть подобрана соответствующая периферия (мониторы, клавиатуры и т.д.).
4. В процессе подбора конфигурации должны использоваться следующие бюджеты:
