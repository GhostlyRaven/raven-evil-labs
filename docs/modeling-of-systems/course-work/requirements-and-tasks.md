...
**3.** Созданная имитационная модель в программе AnyLogic должна иметь визуализацию в 2D моделируемого процесса.

**4.** На проверку преподавателю требуется предоставить полностью написанный отчёт, 5 полностью готовых моделей в программе AnyLogic и 5 файлов с данными экспериментов в формате Excel.
